...
def TracerTracerCross2DA(kA_kB_list, BinsRad, MaskedQueryPosRad, MaskedTracerPosRad_A, MaskedTracerPosRad_B, Verbose=False):
    ...
    See Also
    --------
    kNNpy.kNN_2D_Ang.TracerFieldCross2DA : computes tracer-field cross-correlations using the $k$NN formalism.
...
def TracerTracerCross2DA_DataVector(kA_kB_list, BinsRad, MaskedQueryPosRad, MaskedTracerPosVectorRad_A, MaskedTracerPosRad_B, Verbose=False):
    ...
    See Also
    --------
    kNNpy.kNN_2D_Ang.TracerTracerCross2DA : computes tracer-tracer cross-correlation for a single realisation of both tracers using the $k$NN formalism.
    
    kNNpy.kNN_2D_Ang.TracerFieldCross2DA_DataVector : computes tracer-field cross-correlation data vectors for multiple realisations of the tracer using the $k$NN formalism.

    Notes
    -----
    Please refer to the documentation of kNNpy.kNN_2D_Ang.TracerTracerCross2DA for important usage notes that also apply to this function and references. <Explain why cross-correlating multiple realisations of tracer A with single realisation of tracer B might be useful>
    '''
...
def TracerFieldCross2DA(kList, BinsRad, MaskedQueryPosRad, MaskedTracerPosRad, FieldSkymap, QueryMask, FieldConstPercThreshold, ReturnSmoothedDict=False, Verbose=False):
    ...
    See Also
    --------
    kNNpy.kNN_2D_Ang.TracerTracerCross2DA : computes tracer-tracer cross-correlations using the $k$NN formalism.
...
def TracerFieldCross2DA_DataVector(kList, BinsRad, MaskedQueryPosRad, MaskedTracerPosVectorRad, FieldSkymap, QueryMask, FieldConstPercThreshold, ReturnSmoothedDict=False, Verbose=False):
    ...
    kNNpy.kNN_2D_Ang.TracerTracerCross2DA_DataVector : computes tracer-tracer cross-correlation data vectors for multiple realisations of the first tracer and single realisation of the second tracer using the $k$NN formalism.

    Notes
    -----
    Please refer to the documentation of kNNpy.kNN_2D_Ang.TracerFieldCross2DA for important usage notes that also apply to this function and references. <Explain why cross-correlating multiple realisations of tracer with single realisation of field might be useful>
    '''
